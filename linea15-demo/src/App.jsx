...
const iS={width:"100%",padding:"12px 16px",borderRadius:10,border:"1px solid "+T.bd,background:T.bg,color:T.tx,fontSize:15,fontFamily:"'DM Sans',sans-serif",outline:"none",boxSizing:"border-box"};
    ...
    content=h("div",null,
      ...
      h("div",{style:{display:"flex",gap:6,marginBottom:16,flexWrap:"wrap"}},
        categories.map(function(cat){
          return h("button",{key:cat,onClick:function(){setLogFilter(cat)},style:{padding:"6px 14px",borderRadius:20,border:"1px solid "+(logFilter===cat?T.ac:T.bd),background:logFilter===cat?T.as:"transparent",color:logFilter===cat?T.ac:T.ts,fontSize:12,fontWeight:600,cursor:"pointer",fontFamily:"'DM Sans',sans-serif"}},cat==="all"?"Todos":cat);
        })
      ),
