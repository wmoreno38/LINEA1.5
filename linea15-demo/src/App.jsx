...
function LoginScreen(props) {
  ...
  function doLogin() {
    ...
    if (found) {
      var session = { userId: found.id, username: found.username, name: found.name, email: found.email, role: found.role, loginAt: new Date().toISOString() };
      saveSession(session);
      onLogin(session);
    } else {
  ...
  if(view==="dashboard"&&proj){
    ...
    content=h("div",null,
      ...
      h("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:16,marginBottom:20}},
        h("div",{style:Object.assign({},cS,{cursor:"pointer",textAlign:"center",padding:"32px 20px",border:"2px solid "+T.wn+"55"}),onClick:function(){setView("wizard")}},
          h("div",{style:{fontSize:36,marginBottom:8}},"📝"),h("h3",{style:{margin:0,fontSize:16,fontWeight:800,color:T.wn}},"Llenar Controles"),
          h("div",{style:{marginTop:10}},h("span",{style:bdg(T.wn,T.ws)},(tc-wc)+" pendientes"))
        ),
        h("div",{style:Object.assign({},cS,{cursor:"pointer",textAlign:"center",padding:"32px 20px",border:"2px solid "+T.sc+"55"}),onClick:function(){setView("add-ev")}},
          h("div",{style:{fontSize:36,marginBottom:8}},"📎"),h("h3",{style:{margin:0,fontSize:16,fontWeight:800,color:T.sc}},"Agregar Evidencias"),
          h("div",{style:{marginTop:10}},h("span",{style:bdg(T.sc,T.ss)},te+" registradas"))
        ),
        h("div",{style:Object.assign({},cS,{cursor:"pointer",textAlign:"center",padding:"32px 20px",border:"2px solid "+(eReview>0?T.wn:T.ac)+"55"}),onClick:function(){setView("evidences")}},
          h("div",{style:{fontSize:36,marginBottom:8}},"✅"),h("h3",{style:{margin:0,fontSize:16,fontWeight:800,color:eReview>0?T.wn:T.ac}},"Aprobar Evidencias"),
          h("div",{style:{marginTop:10}},eReview>0?h("span",{style:bdg(T.wn,T.ws)},eReview+" por revisar"):h("span",{style:bdg(T.sc,T.ss)},"Todo al día"))
        )
      ),
